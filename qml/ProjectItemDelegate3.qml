    ...
    trailingActions: ListItemActions {
        actions: [
            Action {
                ...
                onTriggered: entryTimeModClicked(recordId, -15) //Is Connected to Mail Listview on FirstPage.qml
            },
            Action {
                //iconName: "edit"
            ...
            Action {
                //iconName: "edit"
                text:i18n.tr("-60")
                iconSource: "graphics/min60.svg"
                onTriggered: entryTimeModClicked(recordId, -60) //Is Connected to Mail Listview on FirstPage.qml
            }
